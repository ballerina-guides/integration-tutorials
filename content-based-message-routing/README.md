...
3. Define an enum to represent the hospital IDs.
    ...
    ![Define an enum](./resources/define_enum.gif)
...
4. Generate record types corresponding to the response from the hospital backend service by providing a sample of the expected JSON payload.
    ...
    ![Define record types](./resources/define_record_types.gif)
...
<img src="./resources/sequence_diagram.png" alt="Sequence Diagram" height="700" style="width:auto; max-width:100%">
